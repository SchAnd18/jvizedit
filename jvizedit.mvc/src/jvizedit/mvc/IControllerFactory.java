...
public interface IControllerFactory {
	 ...
	 * @param contentManager The content manager context that manages the current controller tree
	 * @param parent The parent controller, this argument is null when the root controller shall be created
	 * @return 
	 */
