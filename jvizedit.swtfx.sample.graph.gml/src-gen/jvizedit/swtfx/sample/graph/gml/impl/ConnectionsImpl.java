 ...
 * </p>
 * <ul>
 *   <li>{@link jvizedit.swtfx.sample.graph.gml.impl.ConnectionsImpl#getConnections <em>Connections</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ConnectionsImpl extends MinimalEObjectImpl.Container implements Connections {
	...
	protected EClass eStaticClass() {
		return GmlPackage.Literals.CONNECTIONS;
	}
	...
	public EList<Connection> getConnections() {
		if (connections == null) {
			connections = new EObjectContainmentEList<Connection>(Connection.class, this, GmlPackage.CONNECTIONS__CONNECTIONS);
		}
		return connections;
	}
