...
/**
 * This is the item provider adapter for a {@link jvizedit.swtfx.sample.graph.gml.Connection} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Connection_src_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Connection_src_feature", "_UI_Connection_type"),
				 GmlPackage.Literals.CONNECTION__SRC,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 GmlPackage.Literals.CONNECTION__TARGET,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addPathPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Connection_path_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Connection_path_feature", "_UI_Connection_type"),
				 GmlPackage.Literals.CONNECTION__PATH,
				 true,
				 false,
				 false,
