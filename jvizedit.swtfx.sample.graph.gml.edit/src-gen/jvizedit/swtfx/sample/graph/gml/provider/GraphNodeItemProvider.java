...
/**
 * This is the item provider adapter for a {@link jvizedit.swtfx.sample.graph.gml.GraphNode} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class GraphNodeItemProvider extends ShapeNodeItemProvider {
	/**
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(GmlPackage.Literals.GRAPH_NODE__CHILDREN);
		}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(GraphNode.class)) {
			case GmlPackage.GRAPH_NODE__CHILDREN:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(GmlPackage.Literals.GRAPH_NODE__CHILDREN,
				 GmlFactory.eINSTANCE.createGraphNode()));

		newChildDescriptors.add
			(createChildParameter
				(GmlPackage.Literals.GRAPH_NODE__CHILDREN,
				 GmlFactory.eINSTANCE.createPort()));
	}
